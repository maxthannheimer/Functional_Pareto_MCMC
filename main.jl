...
N_coarse=20 #number of weather stations/ conditioning points, obersavation points
...
@time (result= MCMC(N_MCMC,observation_data,observation_x0,threshold_quantile, alpha_start, coord_fine,coord_coarse,param_start,row_x0,n_trial_print,N_est_c,N_est_cond))
